...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // assert.equal(objetoRetornado.consumption.length, 4); // Retorno: ['coxinha', 'agua', 'sopa', 'sashimi']
    // ```
    ...
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    // assert.equal(objetoRetornado.pay(), 12.87); // Retorno: somaDosPreçosDosPedidos
    // ```
