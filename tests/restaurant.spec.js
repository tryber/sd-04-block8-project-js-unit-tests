...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu, { food: { 'coxinha': 3.90, 'sanduiche': 9.90 }, drinks: { 'agua': 3.90, 'cerveja': 6.90 } });
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.equal(objetoRetornado.pay(), 27.06);
