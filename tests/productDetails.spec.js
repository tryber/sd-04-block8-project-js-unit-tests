...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const product_details = productDetails('Alcool gel', 'Máscara');
    const firstProductId = product_details[0].details.productId;
    const secondProductId = product_details[1].details.productId;
