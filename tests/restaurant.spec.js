...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // assert.deepStrictEqual(restaurant, {fetchMenu: objeto}); o objeto não contém apenas fetchMenu teste desnecessario
    ...
    restaurant = createMenu(objeto); // reset restaurant
    restaurant.order("coxinha");
    ...
    assert.strictEqual(restaurant.pay(), 12.87);
