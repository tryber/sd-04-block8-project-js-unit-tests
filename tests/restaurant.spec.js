...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    //assert.deepStrictEqual(createMenu(objetoQualquer), { fetchMenu: objetoQualquer }); Tirar duvidas sobre esse teste no plantão
    assert.deepStrictEqual(typeof(createMenu(objetoQualquer).fetchMenu), 'object'); // não sei se essa é a solução correta
