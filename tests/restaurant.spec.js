...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    //assert.equal(createMenu(objetoMenu), {fetchMenu: objetoMenu})
    ...
    assert.deepEqual(objetoRetornado.fetchMenu, objetoMenu)
    ...
    assert.deepEqual(objetoRetornado.pay(), 31.02)
