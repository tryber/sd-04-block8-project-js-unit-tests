...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(productDetails()[0].details.productId.substring(productDetails()[0].details.productId.length - 3), productDetails()[1].details.productId.substring(productDetails()[1].details.productId.length - 3));
  });
});
